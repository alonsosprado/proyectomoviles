...
public class MainActivity2_Nivel4 extends AppCompatActivity {
    ...
    private void numeroAleatorio() {
        String nombreImagenResta = "@drawable/resta";
        String nombreImagenSuma = "@drawable/adicion";
        ...
        if(score <= 39){
            ...
            if (numAleatorio_uno > 0 && numAleatorio_dos <= 4) {
                ...
                iv_Signo.setImageResource(getResources().getIdentifier(nombreImagenSuma, "drawable", getPackageName()));
            } else {
                resultado = numAleatorio_uno - numAleatorio_dos;
                iv_Signo.setImageResource(getResources().getIdentifier(nombreImagenResta, "drawable", getPackageName()));
            }
            if(resultado >= 0){
